...
import pandas as pd
import pickle
st.set_page_config(page_title='home_price_prediction',page_icon='home.icon_png')
st.header('welcome to bengaluru home price prediction')
...
with st.container(border=True):
    ...
    sqft=col2.number_input("Sqft",min_value=200)
